...
import io.naviar.vps_sdk.data.repository.INeuroRepository
import io.naviar.vps_sdk.domain.model.NeuroModel
import io.naviar.vps_sdk.util.ColorUtil
import io.naviar.vps_sdk.util.Constant.MATRIX_ROTATE
import io.naviar.vps_sdk.util.Constant.URL_DELIMITER
import io.naviar.vps_sdk.util.cropTo16x9
import io.naviar.vps_sdk.util.toHalf
...
internal class NeuroInteractor(
    ...
    private fun Bitmap.prepareBitmap(newWidth: Int, newHeight: Int): Bitmap {
        ...
        if (width != newWidth || height != newHeight) {
            scaleFactorImage = newHeight / height.toFloat()
